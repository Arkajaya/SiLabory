        ...
        <footer class=" w-full bg-[#222a4a] text-white rounded-t-3xl shadow-lg">
            <div class="mx-auto w-full max-w-screen-xl p-8 py-6 lg:py-8">
                ...
                <div class="mb-6 md:mb-0">
                    <a href="#" class="flex items-center ">
                        ...
                        <span class="text-heading self-center ml-3 text-2xl font-semibold whitespace-nowrap"><span class="tracking-widest">SILABORY</span> <br><span class="text-sm"> (System Manajemen Lab Inventory)</span></span>
                    </a>
                </div>
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        <h2 class="mb-6 text-sm font-semibold text-heading uppercase">SiLabory</h2>
                    ...
                    <div>
                        <h2 class="mb-6 text-sm font-semibold text-heading uppercase">Feature</h2>
                        <ul class="text-body font-medium">
                            <li class="mb-4">
                                <a href="{{ route('users.list') }}" class="hover:underline ">Peminjaman</a>
                            </li>
                            <li>
                                <a href="{{ route('users.history') }}" class="hover:underline">Riwayat Peminjaman</a>
                            </li>
                        </ul>
                    </div>
                    <div>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-body sm:text-center">© 2023 <a href="https://flowbite.com/" class="hover:underline">SILabory™</a>. All Rights Reserved.
                </span>
