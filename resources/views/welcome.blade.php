...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth">
    ...
    <body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex px-6 lg:px-8 lg:pt-8 items-center lg:justify-center min-h-screen flex-col shadow-sm">
        <header class="w-full lg:max-w-4xl max-w-[335px] text-sm mb-6 not-has-[nav]:hidden z-0">
            @if (Route::has('login'))
                <nav class="flex items-center justify-center gap-4 bg-[#53629E]/10 backdrop-blur-sm rounded-3xl">
                        <a
                            href="/"
                            class="inline-block justify-self-start px-5 py-1.5 font-bold text-xl leading-normal rounded-xl"
                        >
                            SILABORY
                        </a>
                        <a
                    ...
                    @auth
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ms-6 absolute -right-36">
                            <x-dropdown align="right" width="48">
                                <x-slot name="trigger">
                                    <button
                                        class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400  dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150 w-20 h-10">
                                        <svg version="1.1" id="fi_666201" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 460.8 460.8" style="enable-background:new 0 0 240.8 240.8;" xml:space="preserve">
                                            <g>
                                                <g>
                                                    <g>
                    ...
                    @else
                        ...
                        @if (Route::has('register'))
                            <a
                                href="{{ route('register') }}"
                                class=" inline-block px-5 py-1.5 dark:text-[#EDEDEC]  hover:border-[#1915014a] border text-[#1b1b18] dark:border-[#3E3E3A] dark:hover:border-[#62605b] text-sm leading-normal rounded-xl">
                                Register
                            </a>
                        @endif
                    @endauth
        ...
        <section id="blog" class=" py-24 sm:py-16">
            <div class="mx-auto max-w-7xl px-6 lg:px-8 ">
                ...
                @php $blogs = $blogs ?? collect(); @endphp
                ...
                <article class="flex max-w-xl flex-col items-start justify-between">
                    ...
                    <div class="flex items-center gap-x-4 text-xs">
                        ...
                        <a href="#" class="relative z-10 rounded-full bg-gray-800/60 px-3 py-1.5 font-medium text-gray-300 hover:bg-gray-800">{{ $blog->author?->name ?? 'Admin Lab' }}</a>
                    </div>
                    <div class="group relative grow">
                        ...
                        <p class="mt-5 line-clamp-3 text-sm/6 text-gray-400">{{ \Illuminate\Support\Str::limit(strip_tags($blog->content), 150) }}</p>
                    </div>
                    <div class="relative mt-8 flex items-center gap-x-4 justify-self-end">
                        <div class="text-sm/6 ">
                            <p class="font-semibold text-[#473472]/50">
                                Writing by {{ $blog->author?->name ?? 'Admin Lab' }}
                            </p>
                        </div>
                    </div>
                </article>
            ...
            <div class="mx-auto w-full max-w-screen-xl p-8 py-6 lg:py-8">
                ...
                <div class="mb-6 md:mb-0">
                    <a href="#" class="flex items-center ">
                        <img src="{{ asset('logo.png') }}" class="h-12 me-3" alt="Silabory"/>
                        <span class="text-heading self-center text-2xl font-semibold whitespace-nowrap">SILabopy</span>
                    </a>
                </div>
