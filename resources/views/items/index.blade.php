                ...
                @method('PATCH')
                    ...
                    <div>
                        ...
                        <textarea name="condition"
                            class="w-full h-40 text-slate-500 border">{{ old('condition', $item->condition) }}</textarea>
                    </div>
                    <div>
                        ...
                        @else
                        <div
                            class="mb-3 w-28 h-28 bg-gray-100 dark:bg-gray-700 rounded-md flex items-center justify-center text-sm text-gray-500">
                            No Image</div>
                        @endif
