                ...
                @foreach($items as $it)
                    <li class="col-span-1 divide-y divide-gray-200 rounded-lg bg-white shadow">
                        ...
                        <div>
                            <x-primary-button
                                x-data
                                x-on:click="$dispatch('open-modal', 'create-loan-user-{{ $it->id }}')"
                                class="bg-none text-orange-500 w-full rounded-none rounded-b-lg text-center py-2 bg-green-400"
                            >
                                Borrowed
                            </x-primary-button>
                        </div>
                            ...
                            <div class="px-6 pb-6">
                                <form method="POST" action="{{ route('users.store.loan') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                                    ...
                                    <div class="flex justify-end mt-6">
                                        <x-secondary-button
                                            x-on:click="$dispatch('close-modal', 'create-loan-user-{{ $it->id }}')"
                                        >
                                            Cancel
                                        </x-secondary-button>
